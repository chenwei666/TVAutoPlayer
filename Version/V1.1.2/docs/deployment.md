...
1. 从 [GitHub Release v1.1.2](https://github.com/chenwei666/TVAutoPlayer/releases/tag/v1.1.2) 下载 `TVAutoPlayer-v1.1.2-debug.apk` 并复制到 U 盘。
2. 电视开启“允许安装未知来源应用”。
3. 安装 APK，首次打开并选择一个或多个视频。
