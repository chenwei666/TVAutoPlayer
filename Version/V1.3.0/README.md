...
面向 Android TV / 电视盒子的本地图片和视频循环播放应用。V1.3.0 支持图片与视频混合轮播：静态图片按设置的停留时间自动切换，视频播放到结束后切换；应用会扫描电视内部存储和已挂载 U 盘，不依赖第三方文件选择器。
...
[下载 TVAutoPlayer v1.3.0](https://github.com/chenwei666/TVAutoPlayer/releases/tag/v1.3.0)
