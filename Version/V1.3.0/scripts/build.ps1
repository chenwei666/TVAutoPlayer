...
$targetApk = Join-Path $distDirectory 'TVAutoPlayer-v1.3.0-debug.apk'
...
Set-Content -LiteralPath (Join-Path $distDirectory 'TVAutoPlayer-v1.3.0-debug.apk.sha256') `
    -Value "$hash  TVAutoPlayer-v1.3.0-debug.apk" `
    -Encoding ascii
