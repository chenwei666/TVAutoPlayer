...
$targetApk = Join-Path $distDirectory 'TVAutoPlayer-v1.3.1-debug.apk'
...
Set-Content -LiteralPath (Join-Path $distDirectory 'TVAutoPlayer-v1.3.1-debug.apk.sha256') `
    -Value "$hash  TVAutoPlayer-v1.3.1-debug.apk" `
    -Encoding ascii
