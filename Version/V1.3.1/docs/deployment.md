...
1. 从 [GitHub Release v1.3.1](https://github.com/chenwei666/TVAutoPlayer/releases/tag/v1.3.1) 下载 `TVAutoPlayer-v1.3.1-debug.apk` 并复制到 U 盘。
2. 电视开启“允许安装未知来源应用”。
...
- 从 V1.0.0～V1.3.0 升级到 V1.3.1 时保留旧播放列表；旧条目自动按视频处理，图片停留时间默认 10 秒。
- 首次使用 V1.3.1 图片功能时，Android 13+ 可能要求补充照片读取权限；拒绝不会删除已有配置或原文件。
